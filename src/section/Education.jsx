...
const Education = () => {
  return (
    <section
      id="education"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-white"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-lg border border-gray-300 bg-white ${
            ...
            >
              ...
              <p className="mt-4 text-gray-700 font-bold">Percentage: {edu.grade}</p>
              <p className="mt-4 text-gray-600">{edu.desc}</p>
            </div>
          </div>
        ))}
      </div>
